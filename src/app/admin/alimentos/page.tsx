  ...
  return (
    <main className="min-h-[80vh] bg-gray-50 p-4">
      <div className="flex justify-between items-center mb-4">
        ...
        <button onClick={() => { setEditing(undefined); setModalOpen(true); }} className="bg-teal-600 text-white px-4 py-2 rounded hover:bg-teal-700 font-semibold shadow">+ Agregar alimento</button>
      </div>
      {/* Alertas lindas */}
      {successMsg && (
