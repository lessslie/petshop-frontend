...
export default function AlimentosPage() {
  return (
    <main className="min-h-[80vh] flex flex-col items-center justify-center bg-gray-50 py-10">
      <h1 className="text-3xl font-bold text-gray-800 mb-4">Alimentos para Mascotas</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-3xl">
        {/* Card Perros */}
        <Link href="/productos/alimentos/perros" className="bg-white rounded-xl shadow-md border border-gray-200 flex flex-col items-center p-6 hover:shadow-lg transition">
          ...
          <h2 className="text-lg font-semibold text-gray-800 mb-1 mt-2">Alimento para Perros</h2>
          <p className="text-gray-500 mb-2 text-center">Bolsas de 3kg, 7kg y 15kg. Marcas premium y económicas.</p>
          <span className="px-5 py-2 bg-blue-100 text-blue-700 rounded-lg font-semibold shadow hover:bg-blue-300 hover:text-blue-900 transition mt-2">Ver productos</span>
        </Link>
        {/* Card Gatos */}
        <Link href="/productos/alimentos/gatos" className="bg-white rounded-xl shadow-md border border-gray-200 flex flex-col items-center p-6 hover:shadow-lg transition">
          ...
          <h2 className="text-lg font-semibold text-gray-800 mb-1 mt-2">Alimento para Gatos</h2>
