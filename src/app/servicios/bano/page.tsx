...
export default function BanoPage() {
  return (
    <main className="min-h-[80vh] flex flex-col items-center justify-center bg-gray-50 py-10">
      <h1 className="text-3xl font-bold text-gray-800 mb-4">Baño para Perros</h1>
      <p className="text-lg text-gray-600 mb-8 max-w-2xl text-center">
        Ofrecemos servicio de baño profesional para perros de todos los tamaños:
        <br />
        <span className="font-semibold text-gray-700">Grandes, medianos y chicos</span>.
        <br />
        Utilizamos productos hipoalergénicos y agua templada para el máximo confort de tu mascota.
      </p>
        ...
        {[
          {
            size: 'Perro Grande',
            price: '$3500',
            description: 'Para perros de más de 25kg. Incluye baño, secado y cepillado.',
            icon: (
          ...
          },
          {
            size: 'Perro Mediano',
            price: '$2500',
            description: 'Para perros de 10kg a 25kg. Incluye baño, secado y cepillado.',
            icon: (
          ...
          },
          {
            size: 'Perro Chico',
            price: '$1800',
            description: 'Para perros de menos de 10kg. Incluye baño, secado y cepillado.',
            icon: (
          ...
          >
            ...
            <button className="px-5 py-2 bg-blue-100 text-blue-700 rounded-lg font-semibold shadow hover:bg-blue-300 hover:text-blue-900 transition"
              onClick={() => window.location.href = `/turnos/reservar?servicio=ba%C3%B1o&size=${service.size.toLowerCase().replace('perro ', '')}`}
            >
              Solicitar turno
            </button>
          </div>
